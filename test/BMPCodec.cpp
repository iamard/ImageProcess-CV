...
TEST_CASE(BMP_PAL1, "Decode bitmap PAL1 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("pal1.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("pal1o.bmp");
...
TEST_CASE(BMP_RLE4, "Decode bitmap RLE4 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("pal4rle.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("pal4rleo.bmp");
...
TEST_CASE(BMP_PAL4, "Decode bitmap PAL4 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("pal4.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("pal4o.bmp");
...
TEST_CASE(BMP_RLE8, "Decode bitmap RLE8 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("pal8rlecut.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("pal8rleo.bmp");
...
TEST_CASE(BMP_PAL8, "Decode bitmap PAL8 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("pal8.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("pal8o.bmp");
...
TEST_CASE(BMP_BGR16, "Decode bitmap BGR16 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("rgb16.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("rgb16o.bmp");
...
TEST_CASE(BMP_BGR24, "Decode bitmap BGR24 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("rgb24.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("rgb24o.bmp");
...
TEST_CASE(BMP_BGR32, "Decode bitmap BGR32 file test") {
    unique_ptr<BMPDecoder> decoder = BMPDecoder::create("rgb32.bmp");
    unique_ptr<BMPEncoder> encoder = BMPEncoder::create("rgb32o.bmp");
